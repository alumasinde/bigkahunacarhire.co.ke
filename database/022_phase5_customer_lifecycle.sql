...
-- Production-safe and idempotent. Existing columns, indexes and setting values are never changed.
...
-- Add lifecycle settings only when absent; never overwrite production values.
